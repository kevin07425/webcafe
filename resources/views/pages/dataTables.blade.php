...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg pt-5 pl-5 pr-5">
    <div class="pb-8 e dark:bg-gray-900">
                ...
                <tr>
                    <th scope="col" class="p-4">
                        <div class="flex items-center">
                            <input id="checkbox-all-search" type="checkbox" disabled
